...
public class CreateExcelTest {
    public static void main(String[] args) throws Exception{
        ...
        HSSFCell cell = row.createCell(0);//列的编号，从0 开始，依次增加
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            cell=row.createCell(0);//列的编号，从0 开始，依次增加
        ...
        //调用工具函数生成excel文件
        OutputStream os = new FileOutputStream("D:\\CrmProject\\项目资料\\serverDir\\studentList2.xls");
        wb.write(os);
